...
if(isset($_POST['submit'])) {
    ...
    $insert = $mysqli->query("INSERT INTO logindata(Username,Password,Email,Verification)
    VALUES('$u','$p','$e','$vkey'");
    echo $vkey;
    ...
    $message = "Congradulations and thank you for signing up to puentes! You can verify your account Here! </a>";
